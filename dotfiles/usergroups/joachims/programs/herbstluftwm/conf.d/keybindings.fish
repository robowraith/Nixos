...
#    focus_monitor 3 , \
#    use right
hc keybind $Mod+0 spawn ~/.config/herbstluftwm/bin/switch_tag_or_cycle.fish main fullscreen
...
hc keybind $Mod+Shift+0 move fullscreen
...
hc keybind $Mod+Ctrl+0 use fullscreen
